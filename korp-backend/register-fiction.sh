...
$CWBENCODE -s -p - -d /corpora/data/$FN -R /corpora/registry/$FN -c utf8 -f /corpora/$FILENAME -P word -P baseform -P pos -P msd  -S sentence:0+n -S paragraph:0+n -S doc:0+title+original_author+original_title+genre+publisher+number+date+origdate+place+category+notes+year+datefrom+dateto+timefrom+timeto
